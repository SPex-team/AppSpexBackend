...
@admin.register(l_models.Loan)
class Order(admin.ModelAdmin):
    list_display = dd_models.get_all_field_name(l_models.Loan)
    list_display_links = ("id", )
    list_per_page = 10


@admin.register(l_models.LoanItem)
class Order(admin.ModelAdmin):
    list_display = dd_models.get_all_field_name(l_models.LoanItem)
    list_display_links = ("id", )
    list_per_page = 10
